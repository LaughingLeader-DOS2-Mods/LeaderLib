package
{
   ...
   public dynamic class SliderComp extends MovieClip
   {
      ...
      {
         var _loc2_:Number = this.slider_mc.value;
         this.amount_txt.htmlText = String(this.roundFloat(_loc2_));
      ...
      function frame1() : *
      {
         ...
         MainTimeline.SetTextFormat(this.amount_txt);
         MainTimeline.SetTextFormat(this.label_txt);
         MainTimeline.SetTextFormat(this.min_txt);
         MainTimeline.SetTextFormat(this.max_txt);
      }
   }
}
