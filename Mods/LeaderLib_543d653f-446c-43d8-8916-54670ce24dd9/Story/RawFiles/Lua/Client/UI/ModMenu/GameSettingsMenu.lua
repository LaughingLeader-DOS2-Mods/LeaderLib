...
local text = {
	...
	MainTitle_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_MainTitle_Description", "", _ds),
	StarterTierOverrides = ts:CreateFromKey("LeaderLib_UI_GameSettings_StarterTierOverrides", "", _ds),
	StarterTierOverrides_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_StarterTierOverrides_Description", "", _ds),
	SpellsCanCritWithoutTalent = ts:CreateFromKey("LeaderLib_UI_GameSettings_SpellsCanCritWithoutTalent", "", _ds),
	SpellsCanCritWithoutTalent_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_SpellsCanCritWithoutTalent_Description", "", _ds),
	LowerMemorizationRequirements = ts:CreateFromKey("LeaderLib_UI_GameSettings_LowerMemorizationRequirements", "", _ds),
	LowerMemorizationRequirements_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_LowerMemorizationRequirements_Description", "", _ds),
	...
	APSettings_Enabled_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Enabled_Description", "", _ds),
	APSettings_Max = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Max", "", _ds),
	APSettings_Max_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Max_Description", "", _ds),
	APSettings_Start = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Start", "", _ds),
	APSettings_Start_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Start_Description", "", _ds),
	APSettings_Recovery = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Recovery", "", _ds),
	APSettings_Recovery_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_APSettings_Recovery_Description", "", _ds),
	...
	BackstabSettings_AllowTwoHandedWeapons_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_AllowTwoHandedWeapons_Description", "", _ds),
	...
	BackstabSettings_MeleeSpellBackstabMaxDistance_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_MeleeSpellBackstabMaxDistance_Description", "", _ds),
	BackstabSetting_Enabled = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSetting_Enabled", "", _ds),
	BackstabSettings_Enabled_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_Enabled_Description", "", _ds),
	BackstabSettings_TalentRequired = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_TalentRequired", "", _ds),
	BackstabSettings_TalentRequired_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_TalentRequired_Description", "", _ds),
	BackstabSettings_MeleeOnly = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_MeleeOnly", "", _ds),
	BackstabSettings_MeleeOnly_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_MeleeOnly_Description", "", _ds),
	BackstabSettings_SpellsCanBackstab = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_SpellsCanBackstab", "", _ds),
	BackstabSettings_SpellsCanBackstab_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_BackstabSettings_SpellsCanBackstab_Description", "", _ds),
	...
	Button_ClearWhitelist_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Button_ClearWhitelist_Description", "", _ds),
	Button_ClearBlacklist = ts:CreateFromKey("LeaderLib_UI_GameSettings_Button_ClearBlacklist", "", _ds),
	Button_ClearBlacklist_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Button_ClearBlacklist_Description", "", _ds),
	Client = {
		AlwaysDisplayWeaponScalingText_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_AlwaysDisplayWeaponScalingText_Description", "", _ds),
		...
		HideStatuses_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_HideStatuses_Description", "", _ds),
		StatusOptions_AffectHealthbar = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_StatusOptions_AffectHealthbar", "", _ds),
		StatusOptions_AffectHealthbar_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_StatusOptions_AffectHealthbar_Description", "", _ds),
		DivineTalentsEnabled_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_DivineTalentsEnabled_Description", "", _ds),
		AlwaysExpandTooltips = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_AlwaysExpandTooltips", "", _ds),
		AlwaysExpandTooltips_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_AlwaysExpandTooltips_Description", "", _ds),
		HideChatLog = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_HideChatLog", "Hide Chat Log", _ds),
		HideChatLog_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_HideChatLog_Description", "Aggressively prevent the chat log from being visible or toggleable.", _ds),
		ToggleCombatLog = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_ToggleCombatLog", "Toggle Combat Log", _ds),
		ToggleCombatLog_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_ToggleCombatLog_Description", "Make the combat log visible initially.", _ds),
		CondenseItemTooltips = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_CondenseItemTooltips", "Condense Item Tooltips", _ds),
		CondenseItemTooltips_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_CondenseItemTooltips_Description", "Try to reduce max item tooltip size by combining elements, such as \"On Hit\" actions.", _ds),
		...
		EnableTooltipDelay = {
			...
			Generic_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Generic_Description", "Enable a 0.5 second delay for generic tooltips (things like button tooltips).", _ds),
			Item = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Item", "Delay Item Tooltips", _ds),
			Item_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Item_Description", "Enable a 0.5 second delay for item tooltips (includes the hotbar).", _ds),
			Status = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Status", "Delay Status Tooltips", _ds),
			Status_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Status_Description", "Enable a 0.5 second delay for status tooltips (statuses next to portraits, and the examine window).", _ds),
			Skill = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Skill", "Delay Skill Tooltips", _ds),
			Skill_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_EnableTooltipDelay_Skill_Description", "Enable a 0.5 second delay for skill tooltips.", _ds),
		},
		Fade = {
			Enabled = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_FadeInventory_Enabled", "Enabled", _ds),
			Enabled_Description = ts:CreateFromKey("LeaderLib_UI_GameSettings_Client_FadeInventory_Description", "If enabled, specific items will be less visible in the inventory, such as memorized skillsbooks being less opaque.", _ds),
