...
Ext.RegisterConsoleCommand("coroutinetest", function(cmd)
	...
	runProcess(function ()
		...
		print("Hello world. I will now astound you by waiting for 2 seconds.", Ext.MonotonicTime())
		wait(2000)
		print("Haha! I did it!", Ext.MonotonicTime() - startTime)
		...
		print("Move done!", GetPosition(host))
