...
---@param initializedCallback? fun(e:PersistentVarsLoadedEventArgs) If set, this function will be called during the PersistentVarsLoaded event.
---@param autoUpdateVars? boolean If true, GameHelpers.PersistentVars.Update will be called on modGlobalTable.PersistentVars, using defaultTable, during the PersistentVarsLoaded event.
