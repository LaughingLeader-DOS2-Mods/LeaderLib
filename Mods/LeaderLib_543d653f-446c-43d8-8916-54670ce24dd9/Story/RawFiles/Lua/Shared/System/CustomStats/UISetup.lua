...
Ext.RegisterUITypeCall(Data.UIType.characterSheet, "characterSheetUpdateDone", function(...) if CustomStatSystem.Enabled then CustomStatSystem:OnUpdateDone(...) end end, "After")
