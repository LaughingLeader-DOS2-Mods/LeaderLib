...
## Dependency-Free Api
Through flags, events, and databases, integration with LeaderLib can be done without actually setting it as a dependency in the editor. Read more on that here: [LeaderLib ModApi: Getting Started](/https://github.com/LaughingLeader-DOS2-Mods/LeaderLib/wiki/Tutorial:-Creating-an-Updater-Script).
